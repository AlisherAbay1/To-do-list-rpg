...
from src.app.presentation.schemas import ShopListingShortSchemaRead, ShopListingSchemaCreate
...
async def create_current_user_shop_listing(interactor: FromDishka[CreateCurrentUserShopListing], 
