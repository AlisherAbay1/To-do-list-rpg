...
from .shop import ShopListingShortWithFitRequiremenetsSchema, ShopListingShortWithShortInventoryItemSchema
...
__all__ = ("SkillWithTasksAndNextLvlXpSchemaRead", "TaskWithSkillsAndItemsSchemaRead", 
           ...
           "InventoryShortWithItemSchemaRead", "ShopListingShortWithShortInventoryItemSchema")