...
class Task(Base, kw_only=True):
    ...
    category_id: Mapped[Optional[UUID]] = mapped_column(
        ForeignKey("task_category.id", ondelete="SET NULL"), default=None
    )
    repeat_limit: Mapped[Optional[int]] = mapped_column(default=None)
    repeat_frequency: Mapped[Optional[TaskRepeatFrequency]] = mapped_column(
        ENUM(TaskRepeatFrequency, name="repeat_frequency"), default=None
    )
    ...
    type: Mapped[TaskType] = mapped_column(
        ENUM(TaskType, name="task_type"), default=TaskType.AUTO
    )
    difficulty: Mapped[Optional[TaskDifficulty]] = mapped_column(
    ...
    def calculate_task_rewards(self) -> TaskReward:
        ...
        return TaskReward(xp=xp, gold=gold)
