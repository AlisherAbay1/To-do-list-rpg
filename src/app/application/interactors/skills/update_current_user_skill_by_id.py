...
from src.app.application.dto import SkillUpdateDTO, SkillDTO
from src.app.application.mappers import SkillMapper
from uuid import UUID
from src.app.application.exceptions import SessionNotFoundError, SkillNotFoundError, AccessDeniedError
...
class UpdateCurrentUserSkillById:
    ...
    async def __call__(self, skill_id: UUID, dto: SkillUpdateDTO, session_token: str) -> SkillDTO:
